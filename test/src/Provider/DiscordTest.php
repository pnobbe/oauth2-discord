...
class DiscordTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function testGetBaseAccessTokenUrl()
    {
        ...
        $this->assertEquals('/api/oauth2/tokene', $uri['path']);
    }
    ...
    {
        $this->provider->domain = 'https://discordapp.com';
        ...
        $this->assertEquals($this->provider->domain.'/api/oauth2/authorize', $this->provider->getBaseAuthorizationUrl());
        $this->assertEquals($this->provider->domain.'/api/oauth2/token', $this->provider->getBaseAccessTokenUrl([]));
